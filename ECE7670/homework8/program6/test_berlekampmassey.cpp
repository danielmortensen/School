...
// Preliminary Exercise 3 for berlekampmassey method
    {
        ...
        numsys::GF2<4> s[] = {0, {3, numsys::exponent}, {4, numsys::exponent}, {7, numsys::exponent}};
        int nElement = 4;
        auto output = alg::berlekampmassy(s, nElement);
...
// verifies the sequence
    {
        numsys::GF2<4>::set(numsys::viewmode, numsys::power);
        numsys::GF2<4> s[] = {{8,  numsys::exponent},
                                    {1,  numsys::exponent},
                                    {13, numsys::exponent},
                                    {2,  numsys::exponent},
                                    {5,  numsys::exponent},
...
// verifies the sequence {0, 0, a^5, 0, 1, a^10}
    {
        numsys::GF2<4>::set(numsys::viewmode, numsys::power);
        numsys::GF2<4> s[] = {0, 0, {5, numsys::exponent}, 0, 1, {10, numsys::exponent}};
        int nElement = 6;
        auto output = alg::berlekampmassy(s, nElement);
...
// verifies the sequence {a^14, a^13, 1, a^11, a^5, 1} produces 1 + a^14x + a^11x^2 + a^14x^3
    {
        numsys::GF2<4>::set(numsys::viewmode, numsys::power);
        numsys::GF2<4> s[] = {{0,  numsys::exponent},
                                    {0,  numsys::exponent},
                                    {10, numsys::exponent},
                                    {0,  numsys::exponent},
                                    {10, numsys::exponent},
...
// verifies the sequence {a^14, a^13, 1, a^11, a^5, 1} produces 1 + a^14x + a^11x^2 + a^14x^3
    {
        numsys::GF2<4>::set(numsys::viewmode, numsys::power);
        numsys::GF2<4> s[] = {{14, numsys::exponent},
                                    {13, numsys::exponent},
                                    {0,  numsys::exponent},
                                    {11, numsys::exponent},
                                    {5,  numsys::exponent},
...
// Preliminary Exercise 2 for berlekampmassey2 method
    {
        numsys::GF2<1> s[] = {1, 1, 1, 0, 1, 0, 0};
        int nElement = 7;
        auto c = new numsys::GF2<1>[nElement]();
        int L{0};
        alg::berlekampmassy(s, nElement, c, L);
...
// Preliminary Exercise 3 for berlekampmassey2 method
    ...
    {
        numsys::GF2<4>::set(numsys::viewmode, numsys::power);
        numsys::GF2<4> s[] = {0, 0, {5, numsys::exponent},
